    ...
    return (
        <AuthLayoutSplit>
            ...
            <div className="mt-5 grid grid-cols-2 gap-3">
                ...
                <button
                    className="flex items-center justify-center px-4 py-2.5 border border-slate-800 rounded-lg shadow-sm bg-slate-900 text-sm font-medium text-white hover:bg-slate-800 transition-colors"
